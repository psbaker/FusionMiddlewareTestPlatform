...
public class Server {
  ...
  public void start() throws IOException {
    ...
    System.out.println("SMTP server socket bound to " + address);
  ...
  private class ServerSocketLoop implements Runnable {
    public void run() {
      ...
      System.out.println("Started server socket connection loop");
      ...
      while (true) {
        try {
          ...
          System.out.println("Exception in server socket, expected if socket was closed " + e);
          return;
        }
      }
    }
